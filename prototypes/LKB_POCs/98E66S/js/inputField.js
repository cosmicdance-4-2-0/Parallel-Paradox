...
export class InputField {
  ...
  decayAndDiffuse() {
    ...
    // Minimal diffusion: neighbor share to prevent hard spikes.
    // TODO: swap to a configurable kernel (Gaussian, Laplacian) for richer input spread.
  ...
  index(x, y, z) {
    // Wrap edges to keep energy inside the lattice.
